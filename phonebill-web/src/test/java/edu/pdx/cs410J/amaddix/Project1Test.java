...
class Project1Test {
  ...
  void testbillconstructor4(){
    ...
    @Test
    void testreadme() {
      Project4 tproj4 = new Project4();
//        String out = result.getTextWrit0tenToStandardOut();
        Boolean readme = true;
        assertThat(tproj4.readmeMessage(readme), equalTo(1));
    }
    @Test
    void testreadmefalse() {
      Project4 tproj4 = new Project4();
//        String out = result.getTextWrit0tenToStandardOut();
        Boolean readme = false;
        assertThat(tproj4.readmeMessage(readme), equalTo(0));
    }
...
/*
  ...
  void testfileManager2() throws FileNotFoundException, UnsupportedEncodingException, ParserException {
    ...
    Project4 tproj = new Project4(stArray[0], stArray[1], stArray[2], start, end);
  ...
  void testingProject4Correct() {
    ...
    String start = "04/28/2022 01:28 pm";
    String end = "04/28/2022 01:45 pm";
    Project4 tproj= new Project4("unknown", stArray[1], stArray[2], start, end);
  ...
  void testingProject4Incorrect(){
    ...
    Project4 tproj= new Project4(tname, tcaller, tcallee, tstart, tend);
