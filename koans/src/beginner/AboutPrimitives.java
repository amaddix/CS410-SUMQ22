...
public class AboutPrimitives {
    ...
    public void primitivesOfTypeIntHaveAnObjectTypeInteger() {
        Object number = 1;
        Object var = 2;
        assertEquals(getType(number), getType(var));
    ...
    public void integersHaveAFairlyLargeRange() {
        Object var = -2147483648;
        assertEquals(Integer.MIN_VALUE, var);
        var = 2147483647;
        assertEquals(Integer.MAX_VALUE, var);
    }

    @Koan
    public void integerSize() {
        Object var =32;
        assertEquals(Integer.SIZE, var);  // This is the amount of bits used to store an int
    }
    ...
    public void primitivesOfTypeDoubleCanBeDeclaredWithExponents() {
        assertEquals(getType(1e3), getType(2.5e2));
    ...
    public void primitivesOfTypeFloatCanBeDeclaredWithExponents() {
        assertEquals(getType(1e3f), getType(2.5e3f));
